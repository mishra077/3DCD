...
S_dB = database(SDB);
sub_dB = db(SDB,subDB);
videoPath = cell2mat(strcat('/home/cvprlab/backgroud-subtraction2/data/dataset_2014/dataset/',S_dB,'/',sub_dB,'/'));
...
binaryFolder= cell2mat(strcat('/home/cvprlab/backgroud-subtraction2/data/dataset_2014/results_100/',S_dB,'/',sub_dB,'/'));
binaryFolder = strcat(binaryFolder,'/','predicted');
% predicted_ch_last_batch
dscrptr = 'doesntmatter';
processVideoFolder(videoPath, binaryFolder,dscrptr);
disp(S_dB)
disp(sub_dB)
