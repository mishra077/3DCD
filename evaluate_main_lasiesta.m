...
videoPath = cell2mat(strcat('C:\dataset\',S_dB,'\',sub_dB,'\',sub_sub_dB,'\'));
...
binaryFolder='C:\Users\Murari\Downloads\predicted_ch_last\';
% binaryFolder = cell2mat(strcat('C:\results\',S_dB,'\',sub_dB,'\'));

dscrptr = cell2mat(sub_sub_dB);
processVideoFolder_lasiesta(videoPath, binaryFolder,dscrptr,idxToValue);
disp(S_dB)
disp(sub_dB)
