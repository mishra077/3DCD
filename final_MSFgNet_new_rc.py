# -*- coding: utf-8 -*-
"""
Created on Mon Jun 24 20:48:42 2019
...
class MSFgNet(object):
    ...
    def MSFgNet(self, input_shape, input_shape2):
        ...
        #Block-11
        Sum3 = Concatenate(axis = -1)([x_ip, model, y_ip])
    ...
    def initModel_3D(self):
        ...
        sgd = SGD(lr = 6e-04, decay = 0, nesterov = True) #for 50-50 scene = 1e-03,,,, for 50% 5e-04   #decay = 1e-05
